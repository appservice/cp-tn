...
describe('Service Tests', () => {
    ...
    describe('MpkBudgetMapper Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MpkBudgetMapperService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/mpk-budget-mappers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MpkBudgetMapper', () => {

                let entity: MpkBudgetMapper;
                service.find(123).subscribe((_entity: MpkBudgetMapper) => {
                    entity = _entity;
                });
