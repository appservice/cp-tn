...
describe('Service Tests', () => {
    ...
    describe('Cooperation Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CooperationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cooperation';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Cooperation', () => {

                let entity: Cooperation;
                service.find(123).subscribe((_entity: Cooperation) => {
                    entity = _entity;
                });
