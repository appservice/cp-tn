 ...
 */
public class Order2PdfCreatorTest {
    public static final String RESULT = "order2.pdf";
    @Rule
    public MockitoRule mockitoRule = MockitoJUnit.rule();
    private Order2PdfCreator pdfCreator;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        pdfCreator = new Order2PdfCreator(orderRepository);
