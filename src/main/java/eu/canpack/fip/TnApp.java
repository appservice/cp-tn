package eu.canpack.fip;

import eu.canpack.fip.config.ApplicationProperties;
import eu.canpack.fip.config.DefaultProfileUtil;
...
public class TnApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TnApp.class);

    private final Environment env;

    public TnApp(Environment env) {
        this.env = env;
    }
