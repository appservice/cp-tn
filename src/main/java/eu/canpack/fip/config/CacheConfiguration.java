...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(eu.canpack.fip.domain.Cooperation.class.getName(), jcacheConfiguration);
            cm.createCache(eu.canpack.fip.domain.MpkBudgetMapper.class.getName(), jcacheConfiguration);
