...
var UserService = (function () {
    function UserService(http) {
        ...
        this.resourceSearchBySentenceUrl = 'api/users/by-sentence';
    }
    ...
    UserService.prototype.searchBySentence = function (sentence) {
        var _this = this;
        ...
        return this.http.get(this.resourceSearchBySentenceUrl, options)
            .map(function (res) { return _this.convertResponse(res).json; });
    };
