...
var TnSharedLibsModule = (function () {
    function TnSharedLibsModule() {
    }
    TnSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return TnSharedLibsModule;
}());
exports.TnSharedLibsModule = TnSharedLibsModule;
