...
@Component({
    selector: 'tn-emergency-order-item-finder',
    templateUrl: './emergency-order-item-finder.component.html',
    styles: []
})
export class EmergencyOrderItemFinderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.estimationService.findEmergencyOrderByCriteria({
            page: this.page - 1,
