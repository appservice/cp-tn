...
import {Order, OrderType} from '../../order/order.model';
import {OrderService} from '../../order/order.service';

@Component({
    selector: 'tn-orders-in-production',
    templateUrl: './orders-in-production.component.html'
})
export class OrdersInProductionComponent implements OnInit, OnDestroy {
